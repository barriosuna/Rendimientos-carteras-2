  ...
  function montar(R, payload) {
    ...
    R.querySelector('#cards').innerHTML = ESTRATEGIAS.map(e=>{
      ...
      return `<article class="card" id="${e.id}" data-riesgo="${e.riesgoKey}">
        ...
        <div class="prog">
          <div class="prog-txt">
            <p>🔁 En LB podés poner un monto fijo en <b>${e.nombre}</b> y que se invierta solo, sin que tengas que acordarte. <a href="/dca">Por qué conviene invertir así</a></p>
          </div>
